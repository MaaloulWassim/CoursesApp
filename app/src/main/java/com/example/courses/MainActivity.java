...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // creating variables firebase database,
        ...
        //are getting database reference.
        ...
        //calling a method to fetch courses from database.
        getCourses();
    }
    private void getCourses() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildChanged(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                //this method is called when new child is added we are notifying the adapter and making progress bar invisible.
                loadingPB.setVisibility(View.GONE);
                courseRVAdapter.notifyDataSetChanged();
            }
    ...
    private void displayBottomSheet(CourseRVModal modal) {
        ...
        //setting data to different views on below line.
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //opening our EditCourseActivity on below line.
                Intent i = new Intent(MainActivity.this, EditCourseActivity.class);
                //passing our course modal
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // navigating to browser for displaying course details from its url
